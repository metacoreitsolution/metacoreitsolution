                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-card h-100">
                        ...
                        <div class="shape-icon"><img src="assets/img/icon/service_card_2.svg" alt="Icon"> <span
                                class="dots"></span></div>
                        <h3 class="box-title"><a href="hospitalitymanagement">Hospitality Management</a></h3>
                        <p class="service-card_text">Streamline reservations, staff, and guest services from one system.</p>
                        <a href="hospitalitymanagement"
                            class="th-btn">Read More<i class="fa-regular fa-arrow-right ms-2"></i></a>
                        <div class="bg-shape"><img src="assets/img/bg/service_card_bg.png" alt="bg"></div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="service-card h-100">
                        ...
                        <div class="shape-icon"><img src="assets/img/icon/service_card_3.svg" alt="Icon"> <span
                                class="dots"></span></div>
                        <h3 class="box-title"><a href="hotel-management">Hotel Management</a></h3>
                        <p class="service-card_text">Automate booking, housekeeping, and billing for better efficiency.</p><a href="hotel-management"
                            class="th-btn">Read More<i class="fa-regular fa-arrow-right ms-2"></i></a>
                        <div class="bg-shape"><img src="assets/img/bg/service_card_bg.png" alt="bg"></div>
                    </div>
                </div>
