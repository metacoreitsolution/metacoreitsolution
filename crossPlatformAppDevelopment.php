    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Cross Platform App Development</h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6">
                    <div class="title-area mb-35 text-center text-xl-start">
                        ...
                        <h2 class="sec-title">Smart Development for a <span
                                class="text-theme">Mobile-First </span>World</h2>
                    </div>
                    <p class="mt-n2 mb-30 text-center text-xl-start">We build cross-platform apps using Flutter and React Native to run smoothly on both iOS and Android.
Our solutions save time and cost while ensuring a consistent, high-quality user experience across devices.</p>
                    ...
                    <div class="achivement-box-area filter-active-cat1">
                        <div class="filter-item w-100 cat1">
                            <div class="achivement-box">
                                <div class="achivement-box_img"><img src="assets/img/normal/about_3_1_1.jpg"
                                        alt="About"></div>
                                <div class="media-body">
                                    <h3 class="box-title">Single Codebase, Dual Platform</h3>
                                    <p class="achivement-box_text">Develop once and run on both iOS & Android, reducing time and cost without sacrificing quality.</p><a
                                        href="about" class="th-btn">About More</a>
                                </div>
                            </div>
                        </div>
                        <div class="filter-item w-100 cat2">
                            <div class="achivement-box">
                                <div class="achivement-box_img"><img src="assets/img/normal/about_3_1_2.jpg"
                                        alt="About"></div>
                                <div class="media-body">
                                    <h3 class="box-title">Consistent User Interface</h3>
                                    <p class="achivement-box_text">Deliver a smooth, native-like experience across all devices with consistent design and functionality</p><a
                                        href="about" class="th-btn">About More</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-xl-6">
                    <div class="title-area mb-35">
                        ...
                        <h2 class="sec-title">One Codebase. Multiple Platforms. <span class="text-theme"> Maximum Efficiency.</span></h2>
                    </div>
                    <p class="mt-n2 mb-30">Cross-platform code refers to the practice of building mobile applications using a single codebase that runs seamlessly on both iOS and Android devices. Instead of developing two separate apps, developers use powerful frameworks like Flutter and React Native to create one unified app that delivers native-like performance across platforms.</p>
                    <p class="mt-n2 mb-30">At MetaCore IT Solution, we leverage cross-platform technologies to accelerate development timelines, reduce project costs, and ensure consistent design and functionality. This approach allows businesses to reach a broader audience faster—without sacrificing performance, quality, or user experience.</p>
                    <a href="about" class="th-btn">LEARN MORE<i
                ...
                <div class="col-xxl-12 col-lg-8">
                    <div class="page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p>At MetaCore IT Solution, we follow a streamlined, agile approach to cross-platform app development. We begin by understanding your business goals and user expectations, which allows us to define a clear roadmap tailored to your needs. Using powerful frameworks like Flutter and React Native, we design and develop a single codebase that works across both iOS and Android, ensuring speed and consistency.</p>
                            <p class="mb-30">Our process includes UI/UX design, modular development, and continuous testing to ensure native-like performance across devices. We focus on optimizing load times, screen transitions, and responsiveness—delivering a seamless user experience. Throughout development, we involve you through regular demos and feedback loops, making the process transparent and collaborative.</p>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-30">
                                    ...
                                    <div class="checklist style3">
                                        <ul>
                                            <li><i class="fas fa-octagon-check"></i> Single codebase for iOS and Android</li>
                                            <li><i class="fas fa-octagon-check"></i> Built using Flutter and React Native</li>
                                            <li><i class="fas fa-octagon-check"></i> Fast development and quicker time-to-market</li>
                                            <li><i class="fas fa-octagon-check"></i> Scalable architecture with reusable components</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <p class="mb-4">Once development is complete, we handle deployment to both the App Store and Google Play, followed by ongoing support and updates. The result is a high-quality, cost-efficient app that reaches a wider audience without doubling your investment in time or resources.</p>
                            ...
                            <div class="service-feature-wrap">
                                <div class="service-feature">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="service-feature_text">Save time and budget with one team building for both platforms.</p>
                                    </div>
                                </div>
                                <div class="service-feature">
                                    <div class="service-feature_icon"><img src="assets/img/icon/service_feature_2.svg"
                                            alt="icon"></div>
                                    <div class="media-body">
                                        <h4 class="service-feature_title"> Unified User Experience</h4>
                                        <p class="service-feature_text">Consistent interface and performance across all devices..</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion-area accordion" id="faqAccordion">
                        <div class="accordion-card">
                            <div class="accordion-header" id="collapse-item-1"><button
                                    ...
                                    data-bs-target="#collapse-1" aria-expanded="false" aria-controls="collapse-1"> What is cross-platform app development?</button></div>
                            <div id="collapse-1" class="accordion-collapse collapse" aria-labelledby="collapse-item-1"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">It's a method of building mobile apps using a single codebase that runs on both iOS and Android platforms.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-card active">
                            <div class="accordion-header" id="collapse-item-2"><button class="accordion-button"
                                    ...
                                    aria-expanded="true" aria-controls="collapse-2">Which technologies do you use?</button></div>
                            <div id="collapse-2" class="accordion-collapse collapse show"
                                aria-labelledby="collapse-item-2" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">We use modern frameworks like Flutter and React Native to develop high-performance, cross-platform apps.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-card">
                            <div class="accordion-header" id="collapse-item-3"><button
                                    class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">Is cross-platform development cost-effective?</button></div>
                            <div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="collapse-item-3"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p class="faq-text">Yes, it reduces development time and costs by allowing one team to build and maintain a single app for both platforms.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="brand-sec1" data-pos-for="#process-sec" data-sec-pos="top-half">
            <div class="container py-5">
                <div class="slider-area text-center">
                    <div class="swiper th-slider" id="brandSlider1"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_1.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_2.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_3.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_4.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_5.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_6.png" alt="Brand Logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-box py-20"><img src="assets/img/brand/brand_2_1.png" alt="Brand Logo">
                    ...
                    </div><button data-slider-prev="#brandSlider1" class="slider-arrow style3 slider-prev"><i
                            class="far fa-arrow-left"></i></button> <button data-slider-next="#brandSlider1"
