...
?>
    ...
    <div class="space" data-bg-src="assets/img/bg/why_bg_1.png">
     ...
     <section class="bg-top-center z-index-common space" id="service-sec"
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-6 col-sm-9 pe-xl-5">
                    <div class="title-area text-center text-lg-start">
                        ...
                        <h2 class="sec-title text-dark">Technology with Vision. <span class="text-theme">Solutions with </span>Impact.</h2>
                    </div>
                </div>
                <div class="col-auto">
