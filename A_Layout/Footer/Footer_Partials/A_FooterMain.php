                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            ...
                            <div class="th-widget-about style2">
                                ...
                                <div class="th-social"><a href="https://www.linkedin.com/company/metacortex-it-solution/"><i
                                            class="fab fa-linkedin-in"></i></a> <a href="https://www.instagram.com/metacortexitsolution?igsh=ZzA2cHk2Y3VsajZi&utm_source=qr"><i
                            ...
                            <div class="contact-info-container">
                                <ul class="list-unstyled text-white">
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <a href="mailto:info@metaCortexitsolution.com"
                                            class="text-white text-decoration-none">info@metaCortexitsolution.com</a>
                                    </li>
                                    <li>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6">
                        <p class="copyright-text">Copyright: <i class="fal fa-copyright"></i> 2025 . All Rights
                            Reserved by <a href="https://metaCortexitsolution.com/">MetaCortex IT Solution </a></p>
                    </div>
