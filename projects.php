      ...
      <div class="col-md-6">
        <nav class="d-flex align-items-center mb-3">
          <ul class="breadcumb-menu list-unstyled d-flex align-items-center mb-0">
            ...
            <li><a href="portfolio" class="text-primary fw-semibold">Portfolio</a></li>
          </ul>
        </nav>

        <h1 class="breadcumb-title fw-bold mb-3 text-primary">Project</h1>
        <p class="text-dark mb-0">
          Showcasing our successful projects that reflect innovation, precision, and impactful digital transformation.
        </p>
      </div>

      <!-- Right Side: Image -->
      <div class="col-md-6 text-center">
        <img src="./assets/img/hero/project.png" alt="About Us" class="img-fluid" style="max-width: 450px;">
      </div>
                ...
                <div class="about-feature-wrap" style="display: flow;">
                            <div class="about-feature">
                                <div class="media-body">
                                    ...
                                    <p class="about-feature_text">Convert JPEG, PNG, HEIC, and other formats into high-quality PDFs for digitizing physical documents.</p>
                                </div>
                            </div>
                            <div class="about-feature">
                                
                                <div class="media-body">
                                    <h3 class="about-feature_title">PDF Generator:</h3>
            ...
            <div class="col-md-6">
                <div class="about-feature">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="about-feature_text">Optimize file sizes without compromising quality, perfect for sharing via email or cloud.</p>
                                </div>
                            </div>
                            <div class="about-feature">
                                <div class="media-body">
                                    <h3 class="about-feature_title">Document Export:</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-feature-wrap" style="display: flow;">
                            ...
                            <div class="about-feature">
                                <div class="media-body">
                                    <h3 class="about-feature_title">Credential Management: </h3>
                ...
                <div class="col-md-6">
                      <div class="about-feature">
                            ...
                            <div class="about-feature">
                                <div class="media-body">
                                    <h3 class="about-feature_title">Password Management:</h3>
            ...
            <div class="row">
                    ...
                    <div class="about-feature-wrap" style="display: flow;">
                            <div class="about-feature">
                                <div class="media-body">
                                    ...
                                    <p class="about-feature_text">Clients can view availability and book 24/7 via personalized links or widgets.</p>
                                </div>
                            </div>
                            <div class="about-feature">
                                <div class="media-body">
                ...
                <div class="col-md-6">
                    <div class="about-feature">
                            ...
                            <div class="about-feature">
                                <div class="media-body">
                                    <h3 class="about-feature_title">Appointment Reminder:</h3>
